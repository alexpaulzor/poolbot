...
unsigned long valves_moving_until = 0;  // if nonzero, millis when valves should be in place
unsigned long last_valve_current = 0;  // Last time valve current was > 1000mA
unsigned long schedule_until = 0;   // Transition after this time
unsigned long last_mode_change = 0;   // For duration counter
unsigned long last_button_press = 0;  // Last button press (for backlight)
int valve_current = 0;
bool heat_on = false;
